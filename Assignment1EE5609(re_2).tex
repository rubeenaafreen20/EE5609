...
\\
     ...
     Incident vector = \textbf{P-A}
      ...
      \end{align}
        ...
        \begin{align}
        Reflected vector = \textbf{Q-A}
        %   \textbf{b}=\myvec{5-k \\ 3}
        \end{align}

\begin{align}
Vector along x-axis = \bm{a_{x}} =\myvec{0\\1}
\end{align}
\\
From Fig. 0, \\
...
\\
\begin{align}
\dfrac{\vec{(P-A)^T} \Vec{a_x}}{\norm{\Vec{P-A}}}=\dfrac{\vec{(Q-A)^T} \Vec{a_x}}{\norm{\Vec{Q-A}}}
\\
\dfrac{\vec{P^T}\Vec{a_x}-\Vec{A^T}\Vec{a_x}}{ \norm{\Vec{P-A}}}=\dfrac{\vec{Q^T}\Vec{a_x}-\Vec{A^T}\Vec{a_x}}{\norm{\Vec{Q-A}}}
\end{align}
...
Solving the equation (3.0.3) we get:
 k=2.6, -7 \\
 \\

...
\begin{align}
\dfrac{\Vec{d}^{T}\Vec{a_{x}}}{\norm{\Vec{d}}}=\dfrac{\vec{b}^{T}\Vec{a_{x}}}{\norm{\Vec{a_{x}}}}
\end{align}
\implies \dfrac{\myvec{1-k & 2}\myvec{0\\1}}{\sqrt{(1-k)^2+(2)^2}}=\dfrac{\myvec{5-k & 3}\myvec{0\\1}}{\sqrt{(5-k)^2+(3)^2}}
\\
\\
\section{Solution}
\\
...
Solving the equation (3.0.1) we get:
 k=2.6, -7 \\
 \\
